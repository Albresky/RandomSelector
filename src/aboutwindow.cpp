    ...
    ui(new Ui::aboutWindow)
{
    ...
    ui->name->setText(tr("<font style='font-size:18px;font-family:Microsoft YaHei;color:black'><b>随机摇号器</b></font><font style='font-size:12px'>&nbsp;(x64)</font>"));

    ui->version->setText(tr("<font style='font-size:14px'>版本: 1.0</font>"));
    ui->builtdate->setText(tr("<font style='font-size:14px'>Built on May 06 2022</font>"));
